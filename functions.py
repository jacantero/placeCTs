...
# def plot_graph(pandas_df, centros_transformacion_ideales):
...
#     # Dibujamos los centros de masa de potencia
#     for centro in centros_transformacion_ideales:
#         ax.plot(centro[0], centro[1], marker='o', color='blue', markersize=8)
